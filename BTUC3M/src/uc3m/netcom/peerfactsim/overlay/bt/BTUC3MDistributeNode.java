package uc3m.netcom.peerfactsim.overlay.bt;
...
import de.tud.kom.p2psim.overlay.bt.BTMessageHandler;
...
//	private BTOperationManager itsOperationManager;
	 ...
	 */
	private Collection<BTOperationUpload<BTUC3MDistributeNode>> itsUploadOperations;
	
	/**
	 * The download operation for every torrent.
	 */
	private Collection<BTOperationDownload<BTUC3MDistributeNode>> itsDownloadOperations;
	...
	public BTUC3MDistributeNode(BTDataStore theDataBus, OverlayID theOverlayID, short thePeerDistributionPort, BTInternStatistic theStatistic, RandomGenerator theRandomGenerator) {
		...
		this.itsDownloadOperations = new LinkedList<BTOperationDownload<BTUC3MDistributeNode>>();
		this.itsUploadOperations = new  LinkedList<BTOperationUpload<BTUC3MDistributeNode>>();
	}
	...
	public int downloadDocument(OverlayKey theOverlayKey, List<TransInfo> theOtherPeers, OperationCallback theCallback) {
		...
		BTOperationDownload<BTUC3MDistributeNode> downloadOperation = new BTOperationDownload<BTUC3MDistributeNode>(this.itsDataBus, document, this.itsOwnContact, this, this, connectionManager, this.itsStatistic, this.itsRandomGenerator);
	...
	public int uploadDocument(OverlayKey theOverlayKey, OperationCallback theCallback) {
		...
		BTOperationUpload<BTUC3MDistributeNode> uploadOperation = new BTOperationUpload<BTUC3MDistributeNode>(this.itsDataBus, document, this.itsOwnContact, this, this, connectionManager, this.itsStatistic, this.itsRandomGenerator);
		...
		if (! this.itsCurrentlyUploadedDocuments.containsKey(theOverlayKey)) {
			this.itsCurrentlyUploadedDocuments.put(theOverlayKey, new BTMessageHandler(this.itsDataBus, document, this.itsOwnContact,(de.tud.kom.p2psim.overlay.bt.operation.BTOperationUpload) uploadOperation, this.getTransLayer(), connectionManager));
		}
