 ...
 */
public class BTOperationUpload<OwnerType extends DistributionStrategy> extends de.tud.kom.p2psim.overlay.bt.operation.BTOperationUpload<OwnerType> {
	...
	private BTOperationKeepAlive<OwnerType> itsKeepAliveOperation;
        ...
        private BTOperationUnchokingNum<OwnerType> itsChokingNumOp;
	...
	public BTOperationUpload(BTDataStore theDataBus, BTDocument theDocument, BTContact theOwnContact, OwnerType theOwningComponent, OperationCallback<Void> theOperationCallback, BTConnectionManager theConnectionManager, BTInternStatistic theStatistic, RandomGenerator theRandomGenerator) {
		super(theDataBus,theDocument,theOwnContact,theOwningComponent,theOperationCallback,theConnectionManager,theStatistic,theRandomGenerator);
		...
		this.itsKeepAliveOperation = new BTOperationKeepAlive<OwnerType>(this.itsDataBus, this.itsDocument, this.itsOwnContact, this.getComponent(), Operations.EMPTY_CALLBACK, this.itsConnectionManager);
                this.itsChokingNumOp = new BTOperationUnchokingNum<OwnerType>(this.itsDataBus, this.itsDocument, this.getComponent(), Operations.EMPTY_CALLBACK,this.itsStatistic, theRandomGenerator, this.itsConnectionManager, this.itsChokingOperation.getAlgorithm());
