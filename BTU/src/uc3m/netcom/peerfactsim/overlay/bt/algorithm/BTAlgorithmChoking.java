...
public class BTAlgorithmChoking {
    ...
    private void filterInLeecherState(Collection<BTContact> theContacts) {
        ...
        if (theContacts.size() <= (theirRegularUnchokeNumberAsLeecher + theirOptimisticUnchokeNumberAsLeecher)) {
            return;
        } //To few peers in the list. We return just all.
    ...
    private void doRegularUnchoke(Collection<BTContact> theContacts) {
        ...
        if ((Long.MIN_VALUE + 30 * Simulator.SECOND_UNIT) > Simulator.getCurrentTime()) //TODO: CONSTANT???
        {
            ...
            thirtySecondsAgo = Simulator.getCurrentTime() - 30 * Simulator.SECOND_UNIT;
        } //The normale case: We are more than 30 seconds from Long.MIN_VALUE away.
    ...
    public int getRegularUnchokeNumber(boolean asLeecher) {
        ...
        if (asLeecher) {
            return theirRegularUnchokeNumberAsLeecher;
        } else {
            return theirRegularUnchokeNumberAsSeeder;
        }
    ...
    public void setRegularUnchokeNumber(int number, boolean asLeecher) {
        ...
        if (asLeecher) {
            theirRegularUnchokeNumberAsLeecher = number;
        } else {
            theirRegularUnchokeNumberAsSeeder = number;
        }
    ...
    public int getOptimisticUnchokeNumber(boolean asLeecher) {
        ...
        if (asLeecher) {
            return theirOptimisticUnchokeNumberAsLeecher;
        } else {
            return theirOptimisticUnchokeNumberAsSeeder;
        }
    ...
    public void setOptimisticUnchokeNumber(int number, boolean asLeecher) {
        ...
        if (asLeecher) {
            theirOptimisticUnchokeNumberAsLeecher = number;
        } else {
            theirOptimisticUnchokeNumberAsSeeder = number;
        }
