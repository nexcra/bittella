...
/**
 * The <code>AgentChurnModule</code> class
 *
 * @author Ozair Kafray
 * @version $Id$
 */
public class AgentChurnModule extends AbstractModule {

	/**
	 * An instance of Logger
	 */
	private static Logger log = Logger.getLogger(AgentChurnModule.class);
	
	/**
	 * Sets the thread name to module name
	 */
	public AgentChurnModule(){
		super(AgentChurnModule.class.getSimpleName());
	}
