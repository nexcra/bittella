...
public class Connection extends Thread {// extends PeerUpdater{
    ...
    protected File dat_file;
    protected byte[] idf;
    protected TorrentFile torrentf;
    protected String event = "&event=started";
    protected int interval = 150;
    protected boolean first = true;
    protected boolean end = false;
    protected LinkedHashMap<String, Peer> peerL;
    protected long num_want;
