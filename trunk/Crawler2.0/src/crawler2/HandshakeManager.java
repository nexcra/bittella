...
public class HandshakeManager implements DTListener, PeerUpdateListener,
    ...
    private TorrentFile torrent = null;//    private int maxConnectionNumber = 100;
...
//    private long left = 0;
    ...
    private RandomAccessFile[] output_files;//    private PeerUpdater pu = null;
    private ConnectionListener cl = null;//    private List unchokeList = new LinkedList();
    ...
    private LinkedHashMap<String, BitSet> peerAvailabilies = null;    //LinkedHashMap downloaders = new LinkedHashMap<String, Integer>(4);
    ...
    public boolean blockUntilCompletion()throws InterruptedException {
            ...
            synchronized(this.isComplete){
                ...
                while (!this.end) {
                    ...
                    this.isComplete.wait(10000);
                    if(this.lastUnchoking-System.currentTimeMillis() > 120000) return false;
                }
