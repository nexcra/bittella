...
public class GnpLatencyModelTest extends SimulatorTest {
	...
	protected final static Logger log = SimLogger
			.getLogger(GnpLatencyModelTest.class);
	...
	public void setUp() {
		...
		try {
			...
			netLayerFactoryGnp.setGnpFile("test/de/tud/kom/p2psim/impl/network/gnp/testHosts.xml");
	...
	public void testTransmissionDelay() {
		assertEquals(0 * Simulator.MILLISECOND_UNIT, latencyModelGnp
				.getTransmissionDelay(0, 1000)); // 0 bytes at 1000 bytes/s
		assertEquals(500 * Simulator.MILLISECOND_UNIT, latencyModelGnp
				.getTransmissionDelay(500, 1000)); // 500 bytes at 1000 bytes/s
		assertEquals(1000 * Simulator.MILLISECOND_UNIT, latencyModelGnp
				.getTransmissionDelay(1000, 1000)); // 1000 bytes at 1000
													// bytes/s
		assertEquals(2000 * Simulator.MILLISECOND_UNIT, latencyModelGnp
				.getTransmissionDelay(1000, 500)); // 1000 bytes at 500 bytes/s
		assertEquals(Long.MAX_VALUE, latencyModelGnp.getTransmissionDelay(1000,
	...
	private class IPv4TestMessage extends IPv4Message {
	...
	private class UdpTestMessage extends UDPMessage {

		public UdpTestMessage() {
			super(null, (short) 10, (short) 10, 1, false);
		}
