...
public class BTConstants {
	 ...
	 */
	public final static long PEER_TO_TRACKER_MESSAGE_TIMEOUT = 60000;
	 ...
	 */
	public final static long PEER_TO_TRACKER_CONTACT_TIMEOUT = 5 * 60000;
	
	/**
	 * How often gets the upload operation called?
	 */
	public final static long PEER_UPLOAD_OPERATION_PERIOD = Math.max(1000 / 5, 1); //If the simulator has intervals smaller than a second, we use this. Otherwise, we take the minimum: once per second.
	
	/**
	 * How often does a peer send statistic data?
	 */
	public final static long PEER_SEND_STATISTIC_OPERATION_REQUEST_PERIOD = 30 * 60000;
	
	/**
	 * In what intervals can a peer request further peer sets from the tracker?
	 */
	public final static long PEER_SEND_STATISTIC_OPERATION_CALL_PERIOD = 5 * 60000;
	
	/**
	 * How often gets the download operation called?
	 */
	public final static long PEER_DOWNLOAD_OPERATION_PERIOD = Math.max(1000 / 5, 1); //If the simulator has intervals smaller than a second, we use this. Otherwise, we take the minimum: once per second.
	
	/**
	 * Timeout for a handshake to other peers.
	 */
	public final static long PEER_HANDSHAKE_TIMEOUT = 60000;
	
	/**
	 * Timeout for a request to other peers.
	 */
	public final static long PEER_REQUEST_TIMEOUT = 45 * 1000;
	
	/**
	 * If a peer cannot reply to an request from another peer in this time, it will discard the request.
	 */
	public final static long PEER_REPLY_TIMEOUT = 10 * 1000;
	
	/**
	 * How long should a peer wait between connection attempts?
	 * A very low value will result in a flood of requests!
	 */
	public final static long PEER_CONNECT_RETRY = 5 * 60000;
	
	/**
	 * How often gets the keep alive operation called?
	 */
	public final static long PEER_KEEP_ALIVE_OPERATION_PERIOD = 2 * 60000;
	
	/**
	 * If a peer doesn't receive a keep alive message for this time, it will close the connection.
	 */
	public final static long PEER_CONNECTION_TIMEOUT = 5 * 60000;
	
	/**
	 * How often should the regular unchoke recalculation take place?
	 */
	public final static long CHOKING_REGULAR_CHOKING_RECALC_PERIOD = 10 * 1000;
        
        /**
	 * How often should the algorithm to calculate the number of Unchoked Peers take place?
	 */
	public final static long PEER_NUM_SELECTION_RECALC_PERIOD = 10 * 1000;
	
	/**
	 * How often should the optimistic unchoke recalculation take place?
	 */
	public final static long CHOKING_OPTIMISTIC_CHOKING_RECALC_PERIOD = 30 * 1000;
